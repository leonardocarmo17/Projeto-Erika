...
if (isset($_POST['update'])) {
    ...
    if (isset($_FILES['arquivo']) && $_FILES['arquivo']['error'] == 0) {
        ...
        if ($arquivo['size'] > 2000000) {
            $error = "Arquivo muito grande, máximo de 2MB. <br> <a href='../index.php'>Voltar</a>";
     
        } elseif (!in_array($extensao, ['jpg', 'jpeg', 'png', 'gif'])) {
            $error = "Tipo de arquivo não aceito. Permitido: jpg, jpeg, png, gif. <br> <a href='../index.php'>Voltar</a>";
       
        } elseif (!move_uploaded_file($arquivo['tmp_name'], $path)) {
            $error = "Falha ao mover arquivo para a pasta de upload. <br> <a href='../index.php'>Voltar</a>";
        } else {
